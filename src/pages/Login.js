          ...
          >
            ...
            >
                ...
                {!isLoginMode && (
                  ...
                  >
                    ...
                    <motion.input
                      ...
                      whileFocus={{ scale: 1.02, boxShadow: "0 0 0 3px rgba(255, 193, 7, 0.1)" }}
                    />
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02, boxShadow: "0 10px 25px rgba(255, 193, 7, 0.3)" }}
                whileTap={{ scale: 0.98 }}
              >
                <motion.div
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {isLoginMode ? (
                    ...
                    <TranslatableText>Already have an account?</TranslatableText>
                  )}
                </motion.span>
              </AnimatePresence>
              {' '}
